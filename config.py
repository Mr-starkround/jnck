...
bot_token = os.environ.get("BOT_TOKEN", "6985345708:AAEb1YM90Ys5OL7Lh1ERBPBVNq8KjzUK76Q")
# =========================================================== #

db_url = os.environ.get("DB_URL", "mongodb+srv://agathanokos1:agatha@agatha12.1zz7m4z.mongodb.net/true?retryWrites=true&w=majority")
...
🙅‍♂️Pesanmu gagal terkirim {mention}.
